...
class DeployCDHV5110(base.SaharaTestCase):
    ...
    @mock.patch("sahara_plugin_cdh.plugins.cdh.v5_11_0.deploy.CU")
    ...
    @mock.patch("sahara_plugin_cdh.plugins.cdh.v5_11_0.deploy._start_roles")
    @mock.patch("sahara_plugin_cdh.plugins.cdh.v5_11_0.deploy.CU")
    ...
    @mock.patch("sahara_plugin_cdh.plugins.cdh.v5_11_0.deploy."
